          ...
          <div class="table">
            <table>
              <tr>
                <th>店名:</th>
                <td>
                  <input type="text" id="store_name" v-model="val.name" />
                </td>
              </tr>
              <tr>
                <th>店舗説明:</th>
              ...
              <tr>
                <th>エリア:</th>
                <td>
                  <select id="store_area" v-model="val.area_id">
                    <option value="" hidden class="pull_down">{{
                      val.area.area
                    }}</option>
                    <option
            ...
            <button class="button update_button" @click="updateStore">
...
export default {
  ...
  methods: {
    ...
    imageUpdate() {
      ...
      axios
        .post(
          "https://rese-booking.herokuapp.com/api/storeImageUpdate",
          formData
        )
        .then(() => {
          alert("画像を更新しました。");
    ...
    updateStore() {
      this.loading = false;
      axios
        .put("https://rese-booking.herokuapp.com/api/stores", {
          id: this.val.id,
          name: this.val.name,
